...
public class Common_Methods {
	...
	public String currentPageUrl() {
		return SetPageDriver.getCurrentDriver().getCurrentUrl();
	}
	
	//Getting current page title
	
	public String getTitle() {
		return SetPageDriver.getCurrentDriver().getTitle();
	}
	
	/**************************
	 * Write in an input field 
	...
	public void hover(WebElement element) {
		Actions actions = new Actions(SetPageDriver.getCurrentDriver());
		actions.clickAndHold(element).build().perform();
	}
	
	/***********************************
	 *  Shadow Dome Related Task
	...
	/******************************************
	 * Select Tag Related Element Task * 
	 * ****************************************
	 */
	...
	public void clickOnAButtonJs(String script) {
		JavascriptExecutor js = (JavascriptExecutor) SetPageDriver.getCurrentDriver();
	...
	public Alert waitForAlert() {
		wait = new WebDriverWait(SetPageDriver.getCurrentDriver(), Duration.ofSeconds(30));
	...
	// Wait for loading current web page completely* 
